...
| `sweep` | Sweep expansion script (see [Plugins](https://rtl-buddy.github.io/rtl_buddy/v3/concepts/plugins/)) |
| `preproc` | Pre-processing script (see [Plugins](https://rtl-buddy.github.io/rtl_buddy/v3/concepts/plugins/)) |
...
Use `--reg-level` and `--start-level` on the `regression` subcommand to select a level range. See [Regressions](https://rtl-buddy.github.io/rtl_buddy/v3/concepts/regressions/).
