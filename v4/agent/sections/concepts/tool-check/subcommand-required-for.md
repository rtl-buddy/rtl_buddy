...
Exit code semantics under `--required-for` differ slightly from the default — see [Exit codes](https://rtl-buddy.github.io/rtl_buddy/v4/concepts/tool-check/#exit-codes) below.
