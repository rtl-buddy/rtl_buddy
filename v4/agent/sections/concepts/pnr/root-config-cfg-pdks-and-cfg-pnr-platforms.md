...
PDK assets live in `cfg-pdks` (per-process, corners as sub-fields — see the [synthesis page](https://rtl-buddy.github.io/rtl_buddy/v4/concepts/synthesis/#pdk-and-synth-platform-configuration)). `cfg-pnr-platforms` is the P&R-side selector:
