...
A single-block file matches its linked model unconditionally. These fields affect traceability only. See [Spec Traceability](https://rtl-buddy.github.io/rtl_buddy/dev/concepts/spec-traceability/).
