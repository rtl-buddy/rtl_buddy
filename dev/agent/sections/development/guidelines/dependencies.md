...
Classify dependencies as required, integrated, pluggable, or pluggable curated; see [Installation](https://rtl-buddy.github.io/rtl_buddy/dev/install/#dependency-types). Keep required Python dependencies minimal and use optional tools for feature-specific functionality.
...
Update [Tool Dependency Check](https://rtl-buddy.github.io/rtl_buddy/dev/concepts/tool-check/) when manifest behavior changes.
