...
For a full audit, report findings under **Trim** and **Missing**, with one reason and one action per item. Apply [Code Reviews](https://rtl-buddy.github.io/rtl_buddy/dev/development/reviews/) to pull request scope and feedback.
