...
Paths inside `root_config.yaml` resolve from its directory. See [Execution Context](https://rtl-buddy.github.io/rtl_buddy/dev/concepts/execution-context/) for command-root behavior.
