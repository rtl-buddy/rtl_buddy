...
- Verify that `(* anyconst *)` produces an `$anyconst` cell in your frontend; some builds drop it. See [Known Issues](https://rtl-buddy.github.io/rtl_buddy/dev/known-issues/#verify-that-anyconst-elaborates).
