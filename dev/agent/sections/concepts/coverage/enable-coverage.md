...
`cfg-coverage.name` must match the simulator family. `use-lcov: true` enables LCOV conversion and HTML generation. Configure optional Coverview packaging under `cfg-coverview`; see [YAML formats](https://rtl-buddy.github.io/rtl_buddy/dev/reference/yaml/#root_configyaml).
