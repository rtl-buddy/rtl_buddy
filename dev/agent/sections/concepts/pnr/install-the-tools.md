...
A missing KLayout skips GDS or PNG generation without failing the OpenROAD run. Install it later and [export the saved result](https://rtl-buddy.github.io/rtl_buddy/dev/concepts/pnr/#export-a-saved-result) rather than rerunning P&R.
