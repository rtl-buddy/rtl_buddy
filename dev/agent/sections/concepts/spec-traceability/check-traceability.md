...
Use the global `--machine` flag for structured output. See the [CLI reference](https://rtl-buddy.github.io/rtl_buddy/dev/reference/cli/) for all options and [YAML formats](https://rtl-buddy.github.io/rtl_buddy/dev/reference/yaml/) for schemas.
