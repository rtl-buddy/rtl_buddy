...
with no diagnostic at all. See [YAML Formats](https://rtl-buddy.github.io/rtl_buddy/dev/reference/yaml/#elaboration-profiles)
for the accepted range and [Quirks & Known Issues](https://rtl-buddy.github.io/rtl_buddy/dev/known-issues/) for the
