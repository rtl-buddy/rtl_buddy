...
The hub itself has no external binary dependency. The schematic needs `rtl-buddy-sch`, and live wave integration needs the rtl-buddy Surfer fork. See [Installation](https://rtl-buddy.github.io/rtl_buddy/dev/install/#external-tools-by-feature) and [Waveform Viewer](https://rtl-buddy.github.io/rtl_buddy/dev/concepts/wave/).
