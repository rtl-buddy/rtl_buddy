...
Build the [design knowledge graph](https://rtl-buddy.github.io/rtl_buddy/dev/concepts/graph/) after source or config changes, refresh its results after a regression, and use it for relationships that require elaboration or cross config boundaries:
