...
See [Agent Use](https://rtl-buddy.github.io/rtl_buddy/dev/agents/#machine-mode) for the JSON contract and [Tests](https://rtl-buddy.github.io/rtl_buddy/dev/concepts/tests/#interpret-results) for verdicts and exit codes.
