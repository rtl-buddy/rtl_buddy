...
Config-driven commands now anchor managed output on the primary config's directory, the [`command_root`](https://rtl-buddy.github.io/rtl_buddy/dev/concepts/execution-context/).
