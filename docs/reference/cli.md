...
│ --emit-constraints                    generate scoped CDC timing exceptions from the │
│                                       verified crossing set instead of linting       │
│ --format                    FUNCTION  constraint dialect for --emit-constraints      │
│                                       [default: xdc]                                 │
