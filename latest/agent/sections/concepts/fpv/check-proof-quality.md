...
**Negative check.** Deliberately mutate the RTL or strengthen a property beyond the design guarantee and confirm that the expected assertion fails. Use [mutation testing](https://rtl-buddy.github.io/rtl_buddy/v6/concepts/mut/) to automate this across a suite.
