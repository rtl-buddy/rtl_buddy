...
The AXI overlay is a hub view-builder option, not an `rb hier` option. See [Hub](https://rtl-buddy.github.io/rtl_buddy/v6/concepts/hub/#axi-perf-overlay-and-notebook-spawning).
