...
| Run record | — | `artefacts/.dispatch/run-<pid>-<token>.json` (the submitted fleet and its status; see [Interrupted runs](https://rtl-buddy.github.io/rtl_buddy/v6/concepts/dispatch/#interrupted-runs-warn-cancel-adopt)) |
...
[Namespace concurrent runs](https://rtl-buddy.github.io/rtl_buddy/v6/concepts/execution-context/#namespace-concurrent-runs).
