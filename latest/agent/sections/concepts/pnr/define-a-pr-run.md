...
Only `tool: openroad` is supported. Other tool names report `SKIP`. See [YAML Formats: pnr.yaml](https://rtl-buddy.github.io/rtl_buddy/v6/reference/yaml/#pnryaml) for all fields.
