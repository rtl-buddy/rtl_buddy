...
To look at a checkpoint, open its ODB in OpenROAD, or stream its DEF out with [`rb pnr-export --checkpoint`](https://rtl-buddy.github.io/rtl_buddy/v6/concepts/pnr/#export-a-saved-result).
