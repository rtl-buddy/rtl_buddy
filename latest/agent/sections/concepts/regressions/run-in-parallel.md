...
Slurm dispatch requires a Linux submit host, Slurm client commands, and a filesystem shared with compute nodes. See [Parallel Dispatch](https://rtl-buddy.github.io/rtl_buddy/v6/concepts/dispatch/) for cluster configuration, resources, failure recovery, and job accounting.
