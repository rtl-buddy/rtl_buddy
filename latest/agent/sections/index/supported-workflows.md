...
External tools are installed per workflow. See [Installation](https://rtl-buddy.github.io/rtl_buddy/v6/install/#external-tools-by-feature) for the supported integrations.
