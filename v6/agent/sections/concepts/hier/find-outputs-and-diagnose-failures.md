...
For interactive browsing, `rb hub start --serve-viewer --model <name>` builds and serves the same JSON hierarchy. See [Hub](https://rtl-buddy.github.io/rtl_buddy/v6/concepts/hub/).
