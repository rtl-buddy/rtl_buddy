...
| `checkpoints/` | Optional [stage checkpoints](https://rtl-buddy.github.io/rtl_buddy/v6/concepts/pnr/#keep-stage-checkpoints), one directory per run, plus `latest` |
| `abstract/` | Optional [hardened-block abstract](https://rtl-buddy.github.io/rtl_buddy/v6/concepts/pnr/#harden-a-block): LEF, Liberty, GDS and manifest |
