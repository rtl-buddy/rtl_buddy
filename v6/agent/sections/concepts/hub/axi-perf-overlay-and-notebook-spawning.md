...
See [AXI Interconnect Profiling](https://rtl-buddy.github.io/rtl_buddy/v6/concepts/axi-profile/#hub-integration) for how to produce the JSON and transaction Parquet files.
