...
Use [Coverage](https://rtl-buddy.github.io/rtl_buddy/v6/concepts/coverage/) and [Formal Property Verification](https://rtl-buddy.github.io/rtl_buddy/v6/concepts/fpv/) for their payload-specific contracts. Use [Tests](https://rtl-buddy.github.io/rtl_buddy/v6/concepts/tests/#interpret-results) for status and exit-code semantics.
