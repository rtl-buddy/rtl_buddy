...
In machine mode, `rtl_buddy.log` is written as JSON Lines and console output is plain text. See [For Agents](https://rtl-buddy.github.io/rtl_buddy/v5/agents/) for more on machine mode.
