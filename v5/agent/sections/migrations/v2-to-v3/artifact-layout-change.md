...
> v5 went further: hooks no longer run from the suite directory at all. See [Migrating from v4 to v5](https://rtl-buddy.github.io/rtl_buddy/v5/migrations/v4-to-v5/#hook-scripts-run-at-the-invocation-directory).
