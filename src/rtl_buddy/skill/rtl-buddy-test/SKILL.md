...
workspace wipe. There the key is checkout-relative and content-addressed: two
checkouts with identical inputs reuse one directory, different inputs get their
own, and enabling or disabling the root compiles once. Nothing prunes it —
